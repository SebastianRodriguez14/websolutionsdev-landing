...
export const LandingPart01 = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            $rocketIcon.style.transform = `translateY(-260px)`
        }, 50)
    }, [])
    ...
    return <>
        <div id='background-landing' className='w-full h-screen flex justify-center z-0'>
            <img src={logoBackground} className='landing-logo-bg' />
            <img id='rocket-icon' src={rocketIcon} className='landing-rocket-icon' />

        </div>
        <div className='landing-layout w-full h-screen flex justify-center z-10'>
